  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/dapp/sgcdex.finance/',
      qrCode,
      downloadLink: 'https://metamask.app.link/dapp/sgcdex.finance/',
    },
    {
      id: 'trust',
      title: 'Trust Wallet',
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://sgcdex.finance/',
    ...
    },
    {
      ...
      deepLink:
        'https://www.okx.com/download?deeplink=okx%3A%2F%2Fwallet%2Fdapp%2Furl%3FdappUrl%3Dhttps%253A%252F%252Fsgcdex.finance',
      guide: {
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://docs.sgcdex.finance/v/${docLangCodeMapping[code]}/get-started/wallet-guide`
    : `https://docs.sgcdex.finance/get-started/wallet-guide`
