...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of theSGCDEXSquad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0SGCDEXBunny NFTs at the snapshot may also purchase one additionalSGCDEXSquad NFT in the presale for eachSGCDEXBunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of CAKE spent onSGCDEXSquad NFTs will be burned as part of our weekly CAKE burn.')],
  },
  {
