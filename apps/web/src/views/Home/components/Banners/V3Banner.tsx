...
const V3Banner = () => {
  ...
  return (
    ...
    >
      <S.Inner>
        <S.LeftWrapper>
          <Title>{t('SGCDEX V3')}</Title>
          <StyledSubheading data-text={t('Claim $135K CAKE Airdrop & Exclusive NFT')}>
            {t('Claim $135K CAKE Airdrop & Exclusive NFT')}
          </StyledSubheading>
          <NextLinkFromReactRouter
            target="_blank"
            to="https://blog.sgcdex.finance/articles/participate-in-pancake-swap-v3-launch-claim-135-k-cake-airdrop-and-receive-an-exclusive-nft-for-early-supporters"
