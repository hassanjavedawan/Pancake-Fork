import { Button, Flex, LogoWithTextIcon, OpenNewIcon, Text, useMatchBreakpoints } from '@pancakeswap/uikit'
...
export const ZksyncBanner = () => {
  ...
  const title = isDesktop ? t('SGCDEX Now Live on zkSync Era!') : t('Zksync is LIVE!')
