...
import { Button, Flex, Link, LogoWithTextIcon, OpenNewIcon, Svg, Text, useMatchBreakpoints } from '@pancakeswap/uikit'
    ...
    >
      <S.Inner>
        <S.LeftWrapper position="relative" style={{ zIndex: 2, justifyContent: isMobile ? 'flex-start' : 'center' }}>
          ...
          <Header>{isMobile ? t('Linea is LIVE!') : t('SGCDEX Now Live on Linea!')}</Header>
