  ...
  return (
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          13.2 SGCDEX, in its sole discretion, reserves the right to suspend or terminate your account and refuse any
        ...
        <Text as="p">
          Volrex.Network may provide you with trademarks and/or graphical images that can be used to promote SGCDEX. You
          may not modify these trademarks and/or images in any way. Volrex.Network reserves the right to change the
