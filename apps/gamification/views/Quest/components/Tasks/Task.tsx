  ...
  const handleRedirectSwap = () => {
    ...
    if (network && tokenAddress) {
      ...
      const url = isNativeToken
        ? `https://sgcdex.finance/swap?chain=${CHAIN_QUERY_NAME[network]}&persistChain=${network}&outputCurrency=${nativeToken.symbol}`
        : `https://sgcdex.finance/swap?chain=${CHAIN_QUERY_NAME[network]}&persistChain=${network}&outputCurrency=${tokenAddress}`
      window.open(url, '_blank', 'noopener noreferrer')
    }
  }
