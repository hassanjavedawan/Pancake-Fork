...
/**
 * The parameters to use in the call to theSGCDEXRouter to execute a trade.
 */
export interface SwapParameters {
  /**
   * The method to call on theSGCDEXRouter.
   */
  methodName: string
  /**
...
/**
 * Represents theSGCDEXRouter, and has static methods for helping execute trades.
 */
